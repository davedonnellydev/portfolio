					...
					<div className="about-container">
						<div className="about-main">
							<div className="about-right-side">
                                ...
                                <p>Hi! I'm Dave, a frontend developer who has taken a bit of a non-traditional route into tech. For over 15 years, I worked in higher education — handling highly complex systems, working across multiple teams and stakeholders, and helping major projects come to life. I've led rollouts, worked with vendors, wrangled messy data, and made sure the tech side actually worked for the people using it.</p>
                                <p>But over time, I found myself more and more drawn to coding — so I retrained through General Assembly and got stuck into HTML, CSS, JavaScript, React, and Git. Now I'm focused on building clean, accessible web apps that are easy to use and maintain. I enjoy figuring things out, improving workflows, and building interfaces that feel intuitive.</p>
